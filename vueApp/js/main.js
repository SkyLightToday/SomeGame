        ...
        let app = new Vue({
            ...
            methods: {
                ...
                endGame() {
                    this.totalGames++
                    localStorage.getItem('sc2TotalGame', this.totalGames)
                    //zerg
                    if(this.score.zerg > this.protoss && this.score.zerg > this.terran && this.score.primal < 8 && Math.abc(this.score.protoss - this.score.zerg) > 3) {
